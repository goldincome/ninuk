$(function () {
    ...
    var options = {
        ...
        parentDiv: $('#slideshow-container'), // 全体を包むdivのidを指定
        slideSpeed: 50000, // 次の画像に切り替わるまでの時間
        fadeSpeed: 500, // フェードアニメーションの時間
        startPlay: true, // 最初から自動再生しておくかどうか
        maxWidth: 2500, // parentDiv の max-width 値
        thumbMaxWidth: 150,  // サムネイルの max-width 値
        thumbMinWidth: 90, // サムネイルの min-width 値
        thumbHeight: 80,
    };
