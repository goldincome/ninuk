...
<?php $__env->startSection('content'); ?>
    <div>
            ...
            <div class="container md:flex md:space-x-10 py-10 relative z-20">
                ...
                <div class="md:w-1/2 flex">
                    <div class="my-auto pt-8 pb-5">
                        ...
                        <div class="font-extrabold text-3xl md:text-4xl xl:text-3xl leading-10">
                            Starting from £<?php echo e($tin ? $tin->ourService->price : '35'); ?>

                        </div>
                        <div class="mt-6 flex space-x-2">
                            <a href="<?php echo e(route('pre-checkout.show', $tin->slug)); ?>" class="btn btn-nin-green btn-lg">
                                Apply Now
                            </a>
                            <a href="<?php echo e(route('tin')); ?>#requirements" class="btn btn-transparent-black btn-lg">
                                See Requirements
                            </a>
                        </div>
                    </div>
                ...
                <div class="md:w-1/2 hidden md:block">
                    <div class="flex justify-end" style="height: 500px">
                        <img src=<?php echo e(asset('img/bgs/nigeria-tax-indentification-number-tin.png')); ?>
                            ...
                            <div class="mt-6">
                                ...
                                <div class="mt-2 sm:mt-4 font-light">
                                    ...
                                    <div class="font-extrabold text-2xl md:text-2xl xl:text-2xl leading-10">
                                        From £<?php echo e($tin ? $tin->ourService->price : '35'); ?>
            ...
            <div class="container">
                <div class="md:flex md:space-x-8">
                    <div class="md:w-6/12 flex md:hidden mb-10 md:mb-0 rounded-xl overflow-hidden">
                        <img src=<?php echo e(asset('img/bgs/why-need-tin-card.png')); ?> alt="Why you need a TIN tax card"
                    ...
                    <div class="md:w-6/12 hidden md:flex rounded-xl overflow-hidden">
                        <img src=<?php echo e(asset('img/bgs/why-i-need-tin.png')); ?> alt="Why you need a TIN tax card"
                            class="w-full my-auto relative" />
                    </div>
                </div>
            </div>
            ...
            <div class="relative z-10 container">
                <div
                    ...
                    <div class="flex space-x-4 mt-5">
                        <a href="<?php echo e(route('pre-checkout.show', $tin->slug)); ?>" class="btn text-black bg-white btn-lg shadow-lg">
                            Apply Now
                        </a>
                    </div>
                </div>
        ...
        <?php echo $__env->make('common.tin-faqs', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            ...
                            <div class="m-auto">
                                ...
                                <div class="flex px-4 mt-3 sm:mt-6 xl:mt-10">
                                    <div class="m-auto flex space-x-2 md:space-x-4">
                                        <a href="<?php echo e(route('pre-checkout.show', $tin->slug)); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/1573680.cloudwaysapps.com/sttbuemfvw/public_html/resources/views/tin.blade.php ENDPATH**/ ?>