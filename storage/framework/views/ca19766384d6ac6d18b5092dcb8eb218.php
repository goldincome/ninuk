        ...
        <div class="content">
            ...
            <div class="body">
                ...
                <div style="margin-top: 20px;">
                    An appointment has been booked for <?php echo e($data['user_name']); ?>.
                    <?php if($data['appointment']->status === \App\Models\Appointment::TOPAYONCAPTURE): ?>
                        <?php if($data['appointment']->serviceType->slug === $data['appointment']->serviceType::BVN || 
                            ...
                            Remember to come with your reference number <b>#<?php echo e($data['appointment']->ref); ?></b>
                        ...
                        <?php elseif($data['appointment']->serviceType->slug === $data['appointment']->serviceType::BANK_ACCOUNT || 
                            $data['appointment']->serviceType->slug === $data['appointment']->serviceType::BVN_PERSONAL_BANK_ACCOUNT 
                            || $data['appointment']->serviceType->slug === $data['appointment']->serviceType::BVN_CORPORATE_BANK_ACCOUNT): ?>
                        ...
                        <?php elseif($data['appointment']->serviceType->slug === $data['appointment']->serviceType::PASSPORT_5_YEARS || 
                        ...
                        <?php else: ?>
                            Your are to pay when you come for capture. Remember to come with your reference number <b>#<?php echo e($data['ref']); ?></b>
                    ...
                    <?php else: ?>
                        ...
                        Your payment was successful and your appointment with reference number <b>#<?php echo e($data['ref']); ?></b> has been booked.
                ...
                <div style="margin-top: 10px;">
                    ...
                    <div style="margin-bottom: 15px;">
                        ...
                        <span>
                            <?php echo e($data['appointment']->serviceType->name); ?>
                    ...
                    <div style="margin-bottom: 15px;">
                        ...
                        <span>
                            <?php echo e($data['date']->format("M d, Y h:i A")); ?>
                    ...
                    <div style="margin-bottom: 15px;">
                        ...
                        <span>
                            <?php echo e($data['appointmentDurationInMinutes']); ?> mins
                        </span>
                    </div>
                    <div style="margin-bottom: 15px;">
                        <span style="font-weight: bold;">
                        ...
                        <span>
                            <?php echo e($data['appointment']->location->location_name); ?>, <br/>
                            <?php echo e($data['appointment']->location->location_address); ?> <br/>
                            Call: <?php echo e($data['appointment']->location->contact_phone); ?>

                        </span>
                    </div>
                    <?php if($data['appointment']->serviceType->slug === $data['appointment']->serviceType::PASSPORT_5_YEARS || 
                        $data['appointment']->serviceType->slug === $data['appointment']->serviceType::PASSPORT_10_YEARS ): ?>
                        <div style="margin-bottom: 15px;">
                            <span style="font-weight: bold;">
                                Charges Apply<br/>
                    ...
                    <?php else: ?> 
                        <?php if($data['appointment']->card_type === $data['appointment']::CARD_TYPE_PVC): ?>
                            <div style="margin-bottom: 15px;">
                                <span style="font-weight: bold;">
                                    Your <?php echo e($data['appointment']->serviceType->name); ?> PVC will be printed and delivered to your below address<br/>
                                </span>
                                <span>
                                    <?php echo e($data['appointment']->delivery_address); ?>, <?php echo e($data['appointment']->postal_code); ?>  
                                </span>
                            </div>
                        <?php endif; ?>
                        ...
                        <div style="margin-bottom: 15px;">
                            <span style="font-weight: bold;">
                                <?php echo e($data['appointment']->serviceType->name); ?> Booking Capture/Service Amount :<br/>
                            </span>
                            <span>
                                £ <?php echo e($data['appointment']->amount - floatval($data['appointment']->delivery_cost)); ?>
                        ...
                        <?php if($data['appointment']->card_type === $data['appointment']::CARD_TYPE_PVC): ?>
                            <div style="margin-bottom: 15px;">
                                <span style="font-weight: bold;">
                                    <?php echo e($data['appointment']->serviceType->name); ?> PVC Card &  Delivery fee: 
                                </span>
                                <span>
                                    £ <?php echo e($data['appointment']->delivery_cost); ?>
                        ...
                        <?php if($data['appointment']->status === \App\Models\Appointment::TOPAYONCAPTURE): ?>
                            <div style="margin-bottom: 15px;">
                                ...
                                <span>
                                    £ <?php echo e($data['appointment']->amount); ?>

                                </span>
                            </div>
                        <?php endif; ?>
                        <?php if($data['appointment']->status === \App\Models\Appointment::COMPLETED): ?>
                            <div style="margin-bottom: 15px;">
                                <span style="font-weight: bold;">
                                    Total paid : 
                                </span>
...
</html><?php /**PATH /home/1573680.cloudwaysapps.com/sttbuemfvw/public_html/resources/views/emails/newAppointmentInvoiceUserNotification.blade.php ENDPATH**/ ?>