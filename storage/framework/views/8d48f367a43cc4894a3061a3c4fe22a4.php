...
<head>
    ...
    <title>NPC Attestation Birth Certificate Registration Form</title>
    <style>
        @media print {
            body { margin: 0; }
...
<body>
    ...
    <div class="header">
        <h1>NINUK</h1>
        <h2>ATTESTATION OF BIRTH CERTIFICATE REGISTRATION</h2>
        <div class="note">(All Entries in Block Letters.)</div>
    </div>

    <div class="header">
        
        <h2>Reference No : <?php echo e($data['appointment']->ref); ?></h2>
        <h2>Booked Date : <?php echo e($data['date']->format("M d, Y h:i A")); ?></h2>
    </div>
    ...
    <div class="section">
        ...
        <div class="form-row">
            ...
            <span class="form-label">State Of Origin:</span>
            <div class="form-line"></div>
            <span class="form-label">LGA:</span>
            <div class="form-line"></div>
        </div>
    ...
    <div class="section">
     ...
     <div class="section">
        ...
        <ol>
            <li>Make a payment of <strong>£<?php echo e($data['appointment']->amount); ?></strong> to NINUK Ltd by transfer or BACS to Our Business Bank Account:
                <br>Bank Name: Monzo
                <br>SortCode: 040006
...
</html><?php /**PATH /home/1573680.cloudwaysapps.com/sttbuemfvw/public_html/resources/views/emails/pdf/NPCAttestationFormBirthCertificate.blade.php ENDPATH**/ ?>