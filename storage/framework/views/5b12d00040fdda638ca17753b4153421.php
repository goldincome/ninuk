                        ...
                        <div class="bg-white p-8 rounded-xl shadow-lg">
                            <?php if($locations->count() <= 0): ?>
                                <div class="alert alert-danger alert-dismissible" style="margin-bottom: 20px;">
                                    ...
                                    <a href="<?php echo e(route('contactUs')); ?>"> Click here to contact us</a>
                                    <br/><br/>
                                </div>
                            <?php else: ?>
                                <?php echo $__env->make('includes.flash-messages', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> 
                                <form method="POST" name="settings" action="<?php echo e(route('processflightTicket')); ?>" class="submitBookingForm">
                                        ...
                                        <div class="tab-nav-body pt-6">
                                            ...
                                            <div class="tab-nav-body-2">
                                                    ...
                                                    <div class="radio-group">
                                                        <div class="radio-option">
                                                            ...
                                                            <input type="radio" name="trip_type" id="trip_type_return" value="return" class="form-input" 
                                                                   <?php echo e(old('trip_type') === 'return' ? 'checked' : ''); ?> required/>
                                                        </div>
                                                        <div class="radio-option">
                                                            ...
                                                            <input type="radio" name="trip_type" id="trip_type_one_way" value="One Way" class="form-input"
                                                                   <?php echo e(old('trip_type') === 'One Way' ? 'checked' : ''); ?> />
                                                        </div>
                                                        <div class="radio-option">
                                                            ...
                                                            <input type="radio" name="trip_type" id="trip_type_multi_city" value="Multi City" class="form-input"
                                                                   <?php echo e(old('trip_type') === 'Multi City' ? 'checked' : ''); ?> />
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="space-y-2">
                                                      <div class="flex items-center" id="flexi">
                                                        <input
                                                          ...
                                                          <?php echo e(old('trip_method') === 'Flexi' ? 'checked' : ''); ?>
                                                      ...
                                                      <div class="flex items-center" id="direct">
                                                        <input
                                                          ...
                                                          value="Direct"
                                                          class="form-checkbox h-4 w-4 text-blue-600 transition duration-150 ease-in-out"
                                                          <?php echo e(old('trip_method') === 'Direct' ? 'checked' : ''); ?>
                                                ...
                                                <div class="form-group" id="departDiv">
                                                    ...
                                                    <input type="date" name="depart_date"  class="form-input" value="<?php echo e(old('depart_date')); ?>" id="departDate" min='<?php echo date("Y-m-d");?>'/>
                                                </div>
                                                <div class="form-group" id="returnDiv">
                                                    ...
                                                    <input type="date" name="return_date"  class="form-input" value="<?php echo e(old('return_date')); ?>" id="returnDate" min='<?php echo date("Y-m-d");?>'/>
                                                </div>
                                                <div class="form-group">
                                                    <label>
                                                    Adult(>15)
            ...
            <div class="relative z-10 container">
                <div class="py-20 sm:py-32 px-6 md:px-12 max-w-5xl flex items-center text-center flex-col mx-auto text-white">
                    ...
                    <div class="flex space-x-4 mt-5">
                        <a href="<?php echo e(route('contactUs')); ?>" class="btn text-black bg-white btn-lg shadow-lg">
                            Send us a message
                        </a>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/1573680.cloudwaysapps.com/sttbuemfvw/public_html/resources/views/flight-ticket.blade.php ENDPATH**/ ?>