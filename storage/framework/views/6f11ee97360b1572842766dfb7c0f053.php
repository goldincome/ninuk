                ...
                <div class="py-10 md:py-20 mx-auto bg-color-red flex bg-map-red bg-nin-green rounded-xl overflow-hidden">
                    <div class="m-auto">
                        ...
                        <div class="text-center mt-2">
                            <a href="/contact" class="text-white hover:underline">Contact us for further assistance</a>
                        </div>
                    </div>
                </div>
            </div>
...
</div><?php /**PATH E:\xampp\htdocs\nin-uk\resources\views/common/get-started.blade.php ENDPATH**/ ?>