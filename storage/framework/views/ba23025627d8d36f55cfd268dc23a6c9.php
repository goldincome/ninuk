    ...
    <div class="w-full h-full sidebar-bg-ep-pattern bg-cover bg-no-repeat" style="background-position: 0 20px;">
        ...
        <div class="mt-4 sidebar-body h-screen overflow-auto">
            ...
            <?php if(auth()->user()->isSuperAdmin()): ?>
                <a href="<?php echo e(route('admin.locations.index')); ?>" class="sidebar-links admin-sidebar-locations">
                    <span class="fa fa-credit-card w-7"></span>
                    Locations
                </a>
            <?php endif; ?>
...
<?php /**PATH /home/1573680.cloudwaysapps.com/sttbuemfvw/public_html/resources/views/common/admin-sidebar.blade.php ENDPATH**/ ?>