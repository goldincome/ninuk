...
<body>
    ...
    <div class="header">
        <h1>NINUK</h1>
        <h2>TAX IDENTIFICATION FORM REGISTRATION</h2>
    ...
    <div class="section">
        ...
        <div class="form-row">
            ...
            <span class="form-label">BVN No</span>
            <div class="form-line"></div>
        </div>
        ...
        <div class="form-row">
            ...
            <span class="form-label">Nature of Business:</span>
            <div class="form-line"></div>
        </div>
    </div>
     ...
     <div class="section">
        ...
        <ol>
            <li>Make a payment of £<?php echo e($data['appointment']->amount); ?> to NINUK Ltd by transfer or BACS to Our Business Bank Account:
                <br>Bank Name: Monzo
                <br>SortCode: 040006
...
</html><?php /**PATH /home/1573680.cloudwaysapps.com/sttbuemfvw/public_html/resources/views/emails/pdf/TINRegistrationForm.blade.php ENDPATH**/ ?>