    ...
    <div class="container h-14 px-4 mx-auto flex items-center justify-between">
        ...
        <div class="flex-shrink-0 my-auto">
            <a href="/" class="h-10 flex">
                <img src=<?php echo e(asset('img/icons/logo.png')); ?> alt="VHO logo" class="h-8 my-auto object-contain" />
            </a>
        </div>
...
<?php /**PATH /home/1573680.cloudwaysapps.com/sttbuemfvw/public_html/resources/views/common/admin-header.blade.php ENDPATH**/ ?>