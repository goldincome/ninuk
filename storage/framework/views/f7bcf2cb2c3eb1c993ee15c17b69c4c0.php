...
<div class="card-type-pvc hidden">
    <div class="h-32 mb-4">
        <img src=<?php echo e(asset('img/bgs/bvn-card.jpeg')); ?> alt="nin-card" class="w-full h-full object-contain" />
    </div>
...
<div class="card-type-paper hidden">
    <div class="h-44 mb-4">
        <img src=<?php echo e(asset('img/bgs/bvn-printout.jpg')); ?> alt="nin-card" class="w-full h-full object-contain" />
    </div>
    <div style="align-items: center;"><span class="text-lg font-bold leading-6">
...
<?php /**PATH /home/1573680.cloudwaysapps.com/sttbuemfvw/public_html/resources/views/common/our-services/bvn.blade.php ENDPATH**/ ?>