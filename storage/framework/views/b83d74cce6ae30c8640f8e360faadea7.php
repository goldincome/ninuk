                ...
                <div class="md:w-1/2 flex">
                    <div class="my-auto pt-8 pb-5">
                        ...
                        <div class="mt-6 md:leading-6 font-light opacity-70">
                            ...
                            Book an appointment with us, submit your information within minutes and make your BVN/Bank
                            Account available in a few days.
                        </div>
                ...
                <div>
                    ...
                    <div class="mb-16">
                        ...
                        <div class="mt-2 text-lg">
                            The process of obtaining your Nigerian BVN is seamless. It goes through the steps highlighted
                            below
                        </div>
                    </div>
                    ...
                    <div class="mx-auto overflow-hidden grid sm:grid-cols-2 md:grid-cols-3 gap-4 xl:gap-8">
                        ...
                        <div class="h-full block p-8 xl:p-14 rounded-xl shadow-sm bg-white">
                            ...
                            <div class="mt-6">
                                ...
                                <div class="mt-2 sm:mt-4 font-light">
                                    If you choose the option of BVN slip, you will collect it within 10 working days. If you
                                    opt for the BVN PVC Card, we will deliver the card to your specified address once the
                    ...
                    <div class="w-full md:w-6/12">
                        ...
                        <div class="mt-12 space-y-8 md:mr-10">
                            ...
                            <div class="flex space-x-2 text-lg">
                                ...
                                <div>
                                    For easy participation in future investment banking transactions and access credit
                                    opportunities.
                                </div>
                            </div>
                            <div class="flex space-x-2 text-lg">
                ...
                <div
                    ...
                    <div class="mt-5">
                        ...
                        The Nigerian Government has authorized <a href="http://www.deacilprofessionals.com/"
                            class="underline whitespace-nowrap">Deacil Professional Services</a> to process your BVN/Bank
                        account opening without stress and delays.
                        We have the necessary skills and equipment to undertake BVN registration and opening bank account
