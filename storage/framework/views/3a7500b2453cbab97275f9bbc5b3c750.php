    ...
    <div class="content-outer">
        <div class="content">
            ...
            <div class="body">
                ...
                <div>
                    Hello, <?php echo e($data['user_name']); ?>

                </div>

                <div style="margin-top: 20px;">
                    Your application was successful and your reference number <b>#<?php echo e($data['ref']); ?></b>.
                    <?php if($data['appointment']->serviceType->slug === \App\Models\ServiceType::NPC_ATTESTATION_BIRTH_CERTIFICATE || 
                        $data['appointment']->serviceType->slug === \App\Models\ServiceType::NPC_NOTIFICATION_BIRTH_CERTIFICATE): ?><br/>
                        <?php if($data['appointment']->payment->payment_gateway === \App\Enums\PaymentMethodEnum::Offline->value): ?>
                            You have successfully applied for <?php echo e($data['appointment']->serviceType->name); ?> assistance service.<br/>
                            Please, follow the information stated below, <br/>
                            to make payment and process your <?php echo e($data['appointment']->serviceType->name); ?>.
                            Print and fill the attached PDF to this email and and send it back to us along<br/>
                        <?php else: ?>
                            You have successfully booked for <?php echo e($data['appointment']->serviceType->name); ?> assistance service.<br/>
                            Please, print and fill the attached PDF and send it to us via email along<br/>
                        <?php endif; ?>
                       
                        with below required information to enable us process your <?php echo e($data['appointment']->serviceType->name); ?>.
                        <ul>
                            <li>Attach you passport photograph</li>
                            <li>Print the Attached form and Fill it in block letters. </li> 
                        </ul>
                    <?php endif; ?>  
                    <?php if($data['appointment']->serviceType->slug === \App\Models\ServiceType::TAX_IDENTIFICATION_NUMBER): ?>
                        <br/>
                        You have successfully applied for <?php echo e($data['appointment']->serviceType->name); ?> assistance service.<br/>
                        Please, follow the information stated below, <br/>
                        to make payment and process your <?php echo e($data['appointment']->serviceType->name); ?>.
                        Please, print and fill the attached PDF and send it back to us via email along with below required information to enable us process your <?php echo e($data['appointment']->serviceType->name); ?>.
                        <ul>
                    ...
                    <br/>
                    =======================================================
                    <br/>Note: Please, remember to always include your Reference No(<?php echo e($data['ref']); ?>) in all comunication with us.<br/>
                    =============================================================
                    <br/><br/>
...
</html><?php /**PATH /home/1573680.cloudwaysapps.com/sttbuemfvw/public_html/resources/views/emails/newPaidBookingUserNotification.blade.php ENDPATH**/ ?>