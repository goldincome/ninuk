            ...
            <div class="md:flex xl:space-x-10 max-w-5xl mx-auto">
                <div class="mt-5 md:mt-0 flex-grow relative z-10 p-7 sm:p-10 bg-gray-100 overflow-hidden rounded-xl shadow-md">
                    ...
                    <div class="flex items-center space-x-8 mt-4">
                        <a href="<?php echo e(route('pre-checkout.show', $tin ? $tin->slug : '')); ?>" class="btn btn-nin-green btn-lg">
                            Book Now
                        </a>
                    </div>
                </div>
...
</div><?php /**PATH /home/1573680.cloudwaysapps.com/sttbuemfvw/public_html/resources/views/common/tin-requirements.blade.php ENDPATH**/ ?>