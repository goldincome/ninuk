                    ...
                    <div class="mt-10 md:mt-0 md:w-1/2">
                        ...
                        <div class="bg-white p-8 rounded-xl shadow-lg">
                            ...
                            <?php else: ?>
                                ...
                                <form method="POST" name="settings" action="<?php echo e(route('bookings.store')); ?>" class="submitBookingForm">
                                        ...
                                        <div class="tab-nav-body pt-6">
                                            ...
                                            <div class="tab-nav-body-2">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" name="date"  class="form-input" value="<?php echo e(old('date')); ?>" id="appointmentDate" min='<?php echo date("Y-m-d");?>'/>
                                                </div>
                                            ...
                                            <div class="tab-nav-body-3">
                                                ...
                                                <?php $__currentLoopData = $serviceTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $serviceType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if(View::exists('common.our-services.'.$serviceType->slug)): ?> 
                                                        <div id="<?php echo e($serviceType->slug); ?>" class="hidden">
                                                            <?php echo $__env->make('common.our-services.'.$serviceType->slug ?? '', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                        </div>
                                                    <?php endif; ?>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/1573680.cloudwaysapps.com/sttbuemfvw/public_html/resources/views/book/index.blade.php ENDPATH**/ ?>