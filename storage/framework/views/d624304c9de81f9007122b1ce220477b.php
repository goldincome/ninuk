...
<div class="card-type-pvc hidden">
    ...
    <div style="align-items: center;"><span class="text-lg font-bold leading-6">
        Your have chosen Fast Track 10-Years Passport Application processing</br>
...
<div class="card-type-paper hidden">
    ...
    <div style="align-items: center;"><span class="text-lg font-bold leading-6">
        Your have chosen Normal 10-Years Passport Application processing</br>
        Charges applies</br></br>
   ...
   <?php /**PATH /home/1573680.cloudwaysapps.com/sttbuemfvw/public_html/resources/views/common/our-services/passport-application-10-years.blade.php ENDPATH**/ ?>