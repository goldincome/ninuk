...
<head>
    ...
    <title>NIN Down Customer Registration Request- NIN UK</title>
        ...
        <div class="content" style="background:#ffffff;margin:auto;max-width:600px;">
            ...
            <div class="body" style="padding:30px 20px;">
                ...
                <div style="margin-top: 20px;">
                    A new message was received from a user who has requested to be notified when the NIN registration service is back up.
                    <br>
