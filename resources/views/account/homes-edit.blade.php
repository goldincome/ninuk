        ...
        <div class="top-wide">
            <div>
                ...
                <div>
                    ...
                    <span>/</span>
                    <a href="/account/homes/edit/12345678">Edit</a>
                </div>
            </div>
            <div></div>
        </div>
                                        ...
                                        <div class="mt-10 mb-5 border border-gray-200">
                                            ...
                                            <div class="p-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="w-full flex-nowrap overflow-x-auto">
                                                        <div class="flex space-x-4">
                                                            <label class="bg-red-500 cursor-pointer">
                                                                <div class="w-20 h-20 bg-black">
                                                                    <img src="https://unsplash.it/500/382" alt="VHO" class="object-cover m-auto w-full h-full" />
                                                                </div>
                                                                <div class="flex my-2">
                                                                    <input type="checkbox" name="" id="" class="form-input-checkbox mx-auto">
                                                                </div>
                                                            </label>
                                                            <label class="bg-red-500 cursor-pointer">
                                                                <div class="w-20 h-20 bg-black">
