...
@section('title')
    {{$appointment->ref}} - Booking Confirmation
@endsection
                    ...
                    <div class="text-white text-center overflow-hidden">
                        ...
                        <div class="mt-1">
                            @if($appointment->status === \App\Models\Appointment::TOPAYONCAPTURE)
                                ...
                                @endif
                                @if($appointment->serviceType->slug === $appointment->serviceType::BANK_ACCOUNT || 
                                    $appointment->serviceType->slug === $appointment->serviceType::BVN_PERSONAL_BANK_ACCOUNT 
                                    || $appointment->serviceType->slug === $appointment->serviceType::BVN_CORPORATE_BANK_ACCOUNT)
                                ...
                                @endif
                                @if($appointment->serviceType->slug === $appointment->serviceType::NIN)
                                    Your are to pay when you come for capture. </br>
                                    Remember to come with your reference number <b>#{{$appointment->ref}}</b>
                    ...
                    <div class="mt-10 mb-20 bg-white rounded-lg shadow-lg">
                        ...
                        <div class="border-t overflow-auto">
                            ...
                            <div class="my-10 space-y-6">
                                ...
                                @if($appointment->details ? json_decode($appointment->details)->is_booking_appointment : true)
                                <div class="flex mx-20">
                                    <div class="w-10 flex-shrink-0">
                                        <span class="fa fa-calendar text-2xl"></span>
                                    </div>
                                    ...
                                    <div class="flex mx-20">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-lg font-bold">
                                                ...
                                                Phone: {{$appointment->location->contact_phone}} <br/>
                                                Email: {{$appointment->location->contact_email}} <br/>
                                    ...
                                    @if($appointment->serviceType->slug != $appointment->serviceType::PASSPORT_5_YEARS & 
                                        ...
                                        <div class="flex mx-20">
                                            ...
                                            <div>
                                                ...
                                                <div class="text-lg font-bold">
                                                    {{$appointment->card_type === $appointment::CARD_TYPE_PRINT_OUT ? 'print out' : ''}} 
                                                    {{$appointment->card_type === $appointment::CARD_TYPE_PVC ? 'PVC' : ''}} 
                                                </div>
                                            </div>
                                        </div>
                                ...
                                @else
                                    <div class="flex mx-20">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-lg font-bold">
                                                £ {{$appointment->delivery_cost ? $appointment->amount - $appointment->delivery_cost : $appointment->amount}}
                                            </div>
                                        </div>
                                    </div>
                                    
                                    @if($appointment->card_type === \App\Models\Appointment::CARD_TYPE_PVC)
                                        <div class="flex mx-20">
                                            <div class="w-10 flex-shrink-0">
                                                <span class="fa fa-money text-2xl"></span>
                                            </div>
