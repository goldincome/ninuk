...
@section('content')
    <div>
            ...
            <div class="container md:flex md:space-x-10 py-10 relative z-20">
                ...
                <div class="md:w-1/2 flex">
                    <div class="my-auto pt-8 pb-5">
                        ...
                        <div class="font-extrabold text-3xl md:text-4xl xl:text-3xl leading-10">
                            Starting from £{{ $birthCertificate ? $birthCertificate->ourService->price : '45' }}
                        </div>
                        <div class="mt-6 flex space-x-2">
                            <a href="{{route('birthCertificateOptions')}}" class="btn btn-nin-green btn-lg">
                                Apply Now
                            </a>
                            <a href="{{ route('npc-birth-certificate') }}#requirements" class="btn btn-transparent-black btn-lg">
                                See Requirements
                            </a>
                        </div>
                    </div>
                ...
                <div class="md:w-1/2 hidden md:block">
                    <div class="flex justify-end" style="height: 500px">
                        <img src={{asset('img/bgs/npc-birth-certificate-hero.png')}} alt="NPC Birth Certificate Application" class="h-full object-contain" />
                    </div>
                </div>
        ...
        {{-- This section would list the required documents for the application --}}
                            ...
                            <div class="mt-6">
                                ...
                                <div class="mt-2 sm:mt-4 font-light">
                                    ...
                                    <div class="font-extrabold text-2xl md:text-2xl xl:text-2xl leading-10">
                                        From £{{ $birthCertificate ? $birthCertificate->ourService->price : '45' }}
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="md:flex md:space-x-8">
                    <div class="md:w-6/12 flex md:hidden mb-10 md:mb-0 rounded-xl overflow-hidden">
                        <img src={{asset('img/bgs/why-need-npc-cert.png')}} alt="Why you need a birth certificate" class="w-full my-auto relative" />
                    </div>
       ...
       {{-- This section would contain Frequently Asked Questions about the NPC Birth Certificate --}}
       @include('common.npc-faqs')
