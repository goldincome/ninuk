...
@section('content')
    <div>
            ...
            <div class="container md:flex md:space-x-10 py-10 relative z-20">
                ...
                <div class="md:w-1/2 hidden md:block">
                    <div class="flex justify-end" style="height: 500px">
                        <img src={{ asset('img/bgs/nigerian-passport-application.png') }} alt="logo"
        ...
        @include('common.passport-requirements')
                        ...
                        <div
                            ...
                            <div class="m-auto">
                                ...
                                <div class="text-center mt-2">
                                    <a href="{{ route('contactUs') }}" class="text-white hover:underline">Contact us for further
                                        assistance</a>
                                </div>
                            </div>
                        </div>
