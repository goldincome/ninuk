...
<div class="card-type-pvc hidden">
    <div class="h-32 mb-4">
        <img src={{asset('img/bgs/nin-card.jpg')}} alt="nin-card" class="w-full h-full object-contain" />
    </div>
...
<div class="card-type-paper hidden">
    <div class="h-44 mb-4">
        <img src={{asset('img/bgs/nin-paper2.jpg')}} alt="nin-card" class="w-full h-full object-contain" />
    </div>
    <div style="align-items: center;"><span class="text-lg font-bold leading-6">
